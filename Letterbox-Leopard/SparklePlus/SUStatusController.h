...
@interface SUStatusController : NSWindowController {
	...
	IBOutlet NSImageView *authenticatedImage;
	IBOutlet NSTextField *authenticatedText;
}
...
- (void)beginActionWithTitle:(NSString *)title maxProgressValue:(double)maxProgressValue statusText:(NSString *)statusText authenticationIndicator:(BOOL)showAuthenticated;
