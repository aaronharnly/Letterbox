...
@property(readonly) BOOL isSyncable; // @dynamic isSyncable;
...
- (id)activityString;
- (id)prepareRequest;
@property(readonly) NSString *targetFolderIdString; // @dynamic targetFolderIdString;
...
- (void)dealloc;
@property(retain, nonatomic) IMAPAccount *account; // @synthesize account;
@property(retain, nonatomic) NSArray *paths; // @synthesize paths;
...
+ (id)createMessageSetForRange:(CDStruct_f792af56)arg1;
...
@property(nonatomic) unsigned int encoding; // @synthesize encoding;
@property(nonatomic) unsigned int uid; // @synthesize uid;
@property(nonatomic) unsigned int messageFlags; // @synthesize messageFlags;
@property(nonatomic) long long libraryID; // @synthesize libraryID;
...
@property(retain, nonatomic) NSMutableSet *seenItems; // @synthesize seenItems;
@property(retain, nonatomic) id <MessageConsumer> target; // @synthesize target;
@property(retain, nonatomic) NSString *expression; // @synthesize expression;
@property(retain, nonatomic) MessageCriterion *resultParent; // @synthesize resultParent;
@property(retain, nonatomic) MessageCriterion *criterion; // @synthesize criterion;
...
- (void)dealloc;
@property(nonatomic) long long todoRowID; // @synthesize todoRowID=_todoRowID;
@property(copy, nonatomic) NSString *todoID; // @synthesize todoID=_todoID;
...
- (void)dealloc;
@property(retain, nonatomic) LibraryCalendarEvent *calendarEvent; // @synthesize calendarEvent=_calendarEvent;
@property(retain, nonatomic) NSArray *todos; // @synthesize todos=_todos;
@property(retain, nonatomic) MFUUID *noteDocumentID; // @synthesize noteDocumentID=_noteDocumentID;
@property(retain, nonatomic) Message *note; // @synthesize note=_note;
...
@property(nonatomic) BOOL addCountsForMessages; // @synthesize addCountsForMessages=_addCountsForMessages;
...
- (void)dealloc;
@property(nonatomic) BOOL isFollowOnToProgressTask; // @synthesize isFollowOnToProgressTask;
@property(readonly, retain, nonatomic) RemoteStore *store; // @synthesize store;
...
@property BOOL isDirty; // @dynamic isDirty;
...
@property(readonly, nonatomic) struct sqlite3_stmt *compiled; // @synthesize compiled;

@end

@interface QuotaUsage : NSObject
{
    CDStruct_d3e19d9e current;
    CDStruct_d3e19d9e maximum;
}
...
- (BOOL)isEqual:(id)arg1;
- (id)description;
@property(nonatomic) CDStruct_d3e19d9e maximum; // @synthesize maximum;
@property(nonatomic) CDStruct_d3e19d9e current; // @synthesize current;
...
- (id)description;
- (id)remoteID;
@property(nonatomic) BOOL isInIncomingMail; // @synthesize isInIncomingMail;
...
- (id)extension;
- (id)_fullName;
- (long long)_fullNameCompare:(id)arg1;
- (id)email;
...
@property(retain) MailAccount *defaultNoteToDoAccount;
@property(readonly) MailAccount *defaultNoteAccount;
@property(readonly) MailAccount *defaultToDoAccount;
...
+ (id)createExtendedFieldTypeForPropertyId:(long long)arg1;
@end
...
@property(retain) NSTimer *changesTimer;
...
@property(readonly) NSDictionary *dictionaryWithToDosSortedByStore;
...
@property(readonly) BOOL hasToDos;
