...
{
	return [SUUtilities bundleIcon];
}

- (void)beginActionWithTitle:(NSString *)aTitle maxProgressValue:(double)aMaxProgressValue statusText:(NSString *)aStatusText
{
	[self beginActionWithTitle:aTitle maxProgressValue:aMaxProgressValue statusText:aStatusText authenticationIndicator:NO];
}

- (void)beginActionWithTitle:(NSString *)aTitle maxProgressValue:(double)aMaxProgressValue statusText:(NSString *)aStatusText authenticationIndicator:(BOOL)showAuthenticated
{
	...
	[authenticatedText setHidden:(! showAuthenticated)];
	[authenticatedImage setHidden:(! showAuthenticated)];
}
